...
// -----------------------------------------------------------------------------
    ...
    protected function getRawObject($offset=0, $data=null) {
        ...
        switch ($char) {
            ...
            default: {
                $frag='';
                $frag.=isset($data[$offset])?$data[$offset]:NULL;
                $frag.=isset($data[$offset+1])?$data[$offset+1]:NULL;
                $frag.=isset($data[$offset+2])?$data[$offset+2]:NULL;
                $frag.=isset($data[$offset+3])?$data[$offset+3]:NULL;
                switch ($frag) {
                    case 'endo':
                        // indirect object
                        $objtype = 'endobj';
